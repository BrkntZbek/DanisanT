...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"6822612f-1fdb-4fc1-afed-8ee524f59b8e\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.danisant\00", align 1
...
@__DSOCacheEntry_name.3 = internal constant [21 x i8] c"librealm-wrappers.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 3
	%struct.DSOCacheEntry {
